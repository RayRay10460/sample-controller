...
import (
	...
	shidacontrollerv1alpha1 "k8s.io/sample-controller/pkg/apis/shidacontroller/v1alpha1"
	...
	v1alpha1 "k8s.io/sample-controller/pkg/client_bar/listers/shidacontroller/v1alpha1"
)
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&shidacontrollerv1alpha1.Bar{}, f.defaultInformer)
}
