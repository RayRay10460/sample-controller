...
import (
	...
	v1alpha1 "k8s.io/sample-controller/pkg/apis/shidacontroller/v1alpha1"
	scheme "k8s.io/sample-controller/pkg/client_bar/clientset/versioned/scheme"
)
...
type BarInterface interface {
	...
	UpdateStatus(*v1alpha1.Bar) (*v1alpha1.Bar, error)
...
func (c *bars) UpdateStatus(bar *v1alpha1.Bar) (result *v1alpha1.Bar, err error) {
	result = &v1alpha1.Bar{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bars").
